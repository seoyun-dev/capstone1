...
#             Product.objects.create(name=name, description=description, content_url=content_url, price=price, release_date=release_date, sub_category_id=sub_category_id)
